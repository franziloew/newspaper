...
\toprule
  & radikalisierung & auseinandersetzung & definitiv & atommüll & brechen & teils & amerikaner\\
\midrule
\cellcolor{gray!6}{5804} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0}\\
2709 & 0 & 0 & 0 & 0 & 0 & 0 & 0\\
\cellcolor{gray!6}{14655} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0}\\
12840 & 0 & 0 & 0 & 0 & 0 & 0 & 0\\
\cellcolor{gray!6}{10033} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0}\\
\addlinespace
17727 & 0 & 0 & 0 & 0 & 0 & 0 & 0\\
\cellcolor{gray!6}{18713} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0}\\
4277 & 0 & 0 & 0 & 0 & 0 & 0 & 0\\
\cellcolor{gray!6}{9057} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0} & \cellcolor{gray!6}{0}\\
12950 & 0 & 0 & 0 & 0 & 0 & 0 & 0\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\cellcolor{gray!6}{Der Mensch Helmut...} & \cellcolor{gray!6}{Bundesregierung b...} & \cellcolor{gray!6}{0.03} & \cellcolor{gray!6}{DIE WELT} & \cellcolor{gray!6}{DIE LINKE} & \cellcolor{gray!6}{2017-06-18} & \cellcolor{gray!6}{2017-06-12}\\
Deutschlandtrend:... & Brexit-Verhandlu... & 0.04 & DIE WELT & FDP & 2017-06-15 & 2017-06-09\\
\cellcolor{gray!6}{Pressestimmen zum...} & \cellcolor{gray!6}{Brauchen endlich...} & \cellcolor{gray!6}{0.02} & \cellcolor{gray!6}{DIE WELT} & \cellcolor{gray!6}{FDP} & \cellcolor{gray!6}{2017-12-03} & \cellcolor{gray!6}{2017-11-30}\\
Umfrageverlierer ... & Anerkennungsgeset... & 0.12 & DIE WELT & SPD & 2017-06-11 & 2017-06-07\\
\cellcolor{gray!6}{Beate Zschäpe: Ge...} & \cellcolor{gray!6}{Tanz auf dem Vulkan} & \cellcolor{gray!6}{0.01} & \cellcolor{gray!6}{DIE WELT} & \cellcolor{gray!6}{DIE LINKE} & \cellcolor{gray!6}{2017-07-11} & \cellcolor{gray!6}{2017-07-05}\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\cellcolor{gray!6}{2017-08-04} & \cellcolor{gray!6}{DIE WELT} & \cellcolor{gray!6}{DIE LINKE} & \cellcolor{gray!6}{0.09}\\
2017-07-04 & DIE WELT & CDU & 0.18\\
\cellcolor{gray!6}{2017-06-14} & \cellcolor{gray!6}{DIE WELT} & \cellcolor{gray!6}{CDU} & \cellcolor{gray!6}{0.13}\\
2017-12-30 & DIE WELT & DIE LINKE & 0.20\\
...
\(\beta_2W_t+\beta_3W_t*T_t\). The terms \(W_t\) and \(W_t*T_t\) should
absorb any smooth relationship between the date and \(\epsilon_t\) in
the days surrounding the election day. If the RD assumption is valid
(i.e., \(\epsilon_t\) does not change discontinuously at the election
day) the estimate of \(\beta_1\), the coefficient of interest, will be
unbiased even without further controls. However, in the following
section dummy variables for each party \(k\) (\(D_{t,k-1}\)) are
included in the model to estimate the isolated effect for each news
paper / party pair.

\[
\ln(\text{CS}_{t})=\beta_0+\beta_1T_t+\beta_2W_{t}+\beta_3D_{t,k-1}+\beta_4T_tD_{t,k-1}+\epsilon_t
\]

Including interaction terms \(T_tD_{t,k-1}\) - and since we are
...
\begin{table}[!htbp] \centering    \caption{Results from the regression discontinuity model}    \label{table:results_rd1}  \resizebox{0.99\textwidth}{!}{\begin{tabular}{@{\extracolsep{5pt}}lccccccc}  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{7}{c}{\textit{Dependent variable:}} \\  \cline{2-8}  \\[-1.8ex] & \multicolumn{7}{c}{Cosine similarity of topic distribution} \\   & DIE WELT & stern.de & ZEIT ONLINE & Handelsblatt & FOCUS Online & Bild.de & SPIEGEL ONLINE \\  \\[-1.8ex] & (1) & (2) & (3) & (4) & (5) & (6) & (7)\\  \hline \\[-1.8ex]   treated & $-$0.169$^{***}$ & $-$0.118$^{**}$ & $-$0.145$^{**}$ & $-$0.242$^{***}$ & $-$0.058 & $-$0.032 & 0.035 \\    & (0.045) & (0.057) & (0.065) & (0.060) & (0.048) & (0.066) & (0.055) \\    & & & & & & & \\   X\_centered & $-$0.001$^{*}$ & $-$0.0005 & $-$0.002$^{***}$ & $-$0.0003 & $-$0.001 & $-$0.001 & $-$0.002$^{***}$ \\    & (0.0004) & (0.001) & (0.001) & (0.001) & (0.0005) & (0.001) & (0.001) \\    & & & & & & & \\   treatedTRUE:X\_centered & 0.003$^{***}$ & 0.003$^{***}$ & 0.002$^{*}$ & 0.005$^{***}$ & 0.002$^{**}$ & 0.003$^{***}$ & 0.003$^{***}$ \\    & (0.001) & (0.001) & (0.001) & (0.001) & (0.001) & (0.001) & (0.001) \\    & & & & & & & \\   Constant & $-$1.972$^{***}$ & $-$2.181$^{***}$ & $-$1.927$^{***}$ & $-$1.812$^{***}$ & $-$2.091$^{***}$ & $-$2.080$^{***}$ & $-$2.160$^{***}$ \\    & (0.029) & (0.036) & (0.045) & (0.043) & (0.033) & (0.046) & (0.038) \\    & & & & & & & \\  \hline \\[-1.8ex]  Observations & 1,212 & 1,218 & 1,244 & 1,046 & 1,268 & 1,161 & 1,264 \\  R$^{2}$ & 0.031 & 0.011 & 0.059 & 0.035 & 0.005 & 0.013 & 0.009 \\  Adjusted R$^{2}$ & 0.028 & 0.009 & 0.056 & 0.032 & 0.003 & 0.011 & 0.007 \\  Residual Std. Error & 0.377 (df = 1208) & 0.471 (df = 1214) & 0.586 (df = 1240) & 0.491 (df = 1042) & 0.427 (df = 1264) & 0.579 (df = 1157) & 0.495 (df = 1260) \\  F Statistic & 12.805$^{***}$ (df = 3; 1208) & 4.655$^{***}$ (df = 3; 1214) & 25.810$^{***}$ (df = 3; 1240) & 12.532$^{***}$ (df = 3; 1042) & 2.134$^{*}$ (df = 3; 1264) & 5.154$^{***}$ (df = 3; 1157) & 3.820$^{***}$ (df = 3; 1260) \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{7}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}}  \end{table}
...
\begin{table}[!htbp] \centering    \caption{Results from the regression discontinuity model}    \label{table:results_rd2}  \resizebox{0.99\textwidth}{!}{\begin{tabular}{@{\extracolsep{5pt}}lccccccc}  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{7}{c}{\textit{Dependent variable:}} \\  \cline{2-8}  \\[-1.8ex] & \multicolumn{7}{c}{Cosine similarity of topic distribution} \\   & DIE WELT & stern.de & ZEIT ONLINE & Handelsblatt & FOCUS Online & Bild.de & SPIEGEL ONLINE \\  \\[-1.8ex] & (1) & (2) & (3) & (4) & (5) & (6) & (7)\\  \hline \\[-1.8ex]   treated & $-$0.132$^{**}$ & $-$0.011 & $-$0.028 & $-$0.076 & $-$0.063 & $-$0.176$^{*}$ & 0.091 \\    & (0.063) & (0.080) & (0.096) & (0.091) & (0.068) & (0.097) & (0.081) \\    & & & & & & & \\   X\_centered & 0.0003 & 0.001 & $-$0.001$^{**}$ & 0.002$^{***}$ & 0.0002 & 0.001 & $-$0.001 \\    & (0.0003) & (0.0004) & (0.001) & (0.0005) & (0.0004) & (0.001) & (0.0004) \\    & & & & & & & \\   source2B90/GRÜNE & $-$0.267$^{***}$ & $-$0.215$^{***}$ & $-$0.180$^{**}$ & 0.104 & $-$0.338$^{***}$ & $-$0.445$^{***}$ & $-$0.187$^{***}$ \\    & (0.049) & (0.062) & (0.078) & (0.068) & (0.054) & (0.081) & (0.064) \\    & & & & & & & \\   source2CDU & $-$0.259$^{***}$ & $-$0.115$^{*}$ & $-$0.232$^{***}$ & 0.098 & $-$0.288$^{***}$ & $-$0.450$^{***}$ & $-$0.170$^{***}$ \\    & (0.048) & (0.062) & (0.078) & (0.068) & (0.054) & (0.081) & (0.064) \\    & & & & & & & \\   source2DIE LINKE & $-$0.251$^{***}$ & $-$0.109$^{*}$ & $-$0.160$^{**}$ & 0.134$^{**}$ & $-$0.270$^{***}$ & $-$0.342$^{***}$ & $-$0.156$^{**}$ \\    & (0.048) & (0.062) & (0.078) & (0.068) & (0.054) & (0.081) & (0.064) \\    & & & & & & & \\   source2FDP & $-$0.291$^{***}$ & $-$0.195$^{***}$ & $-$0.201$^{***}$ & 0.069 & $-$0.355$^{***}$ & $-$0.441$^{***}$ & $-$0.292$^{***}$ \\    & (0.048) & (0.062) & (0.078) & (0.068) & (0.054) & (0.081) & (0.064) \\    & & & & & & & \\   source2SPD & $-$0.278$^{***}$ & $-$0.143$^{**}$ & $-$0.201$^{***}$ & 0.098 & $-$0.339$^{***}$ & $-$0.479$^{***}$ & $-$0.266$^{***}$ \\    & (0.048) & (0.062) & (0.078) & (0.068) & (0.054) & (0.081) & (0.064) \\    & & & & & & & \\   treatedTRUE:source2B90/GRÜNE & 0.052 & $-$0.144 & $-$0.252$^{**}$ & $-$0.292$^{**}$ & 0.052 & 0.216$^{*}$ & $-$0.036 \\    & (0.080) & (0.102) & (0.124) & (0.121) & (0.087) & (0.125) & (0.104) \\    & & & & & & & \\   treatedTRUE:source2CDU & $-$0.080 & $-$0.223$^{**}$ & $-$0.161 & $-$0.274$^{***}$ & $-$0.073 & 0.148 & $-$0.166$^{*}$ \\    & (0.071) & (0.090) & (0.111) & (0.105) & (0.078) & (0.112) & (0.093) \\    & & & & & & & \\   treatedTRUE:source2DIE LINKE & $-$0.063 & $-$0.089 & $-$0.123 & $-$0.163 & $-$0.074 & 0.092 & $-$0.135 \\    & (0.071) & (0.090) & (0.111) & (0.105) & (0.078) & (0.112) & (0.093) \\    & & & & & & & \\   treatedTRUE:source2FDP & 0.065 & 0.078 & $-$0.083 & $-$0.063 & 0.104 & 0.218$^{*}$ & 0.107 \\    & (0.071) & (0.091) & (0.111) & (0.105) & (0.078) & (0.113) & (0.093) \\    & & & & & & & \\   treatedTRUE:source2SPD & 0.012 & $-$0.101 & $-$0.091 & $-$0.191$^{*}$ & 0.058 & 0.236$^{**}$ & $-$0.017 \\    & (0.072) & (0.091) & (0.112) & (0.106) & (0.079) & (0.113) & (0.094) \\    & & & & & & & \\   Constant & $-$1.686$^{***}$ & $-$1.988$^{***}$ & $-$1.720$^{***}$ & $-$1.783$^{***}$ & $-$1.787$^{***}$ & $-$1.639$^{***}$ & $-$1.917$^{***}$ \\    & (0.039) & (0.050) & (0.062) & (0.056) & (0.043) & (0.064) & (0.052) \\    & & & & & & & \\  \hline \\[-1.8ex]  Observations & 1,212 & 1,218 & 1,244 & 1,046 & 1,268 & 1,161 & 1,264 \\  R$^{2}$ & 0.099 & 0.044 & 0.089 & 0.028 & 0.086 & 0.061 & 0.046 \\  Adjusted R$^{2}$ & 0.090 & 0.034 & 0.080 & 0.016 & 0.077 & 0.052 & 0.037 \\  Residual Std. Error & 0.365 (df = 1199) & 0.465 (df = 1205) & 0.579 (df = 1231) & 0.495 (df = 1033) & 0.411 (df = 1255) & 0.566 (df = 1148) & 0.487 (df = 1251) \\  F Statistic & 10.939$^{***}$ (df = 12; 1199) & 4.569$^{***}$ (df = 12; 1205) & 10.021$^{***}$ (df = 12; 1231) & 2.447$^{***}$ (df = 12; 1033) & 9.797$^{***}$ (df = 12; 1255) & 6.262$^{***}$ (df = 12; 1148) & 4.990$^{***}$ (df = 12; 1251) \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{7}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}}  \end{table}
...
University. E-mail: hlavac at fas.harvard.edu \% Date and time: So, Sep
12, 2021 - 15:29:18
