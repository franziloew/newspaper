...
different during election campaigns, i.e.~the topic similarity changes
after the election a regression discontinuity model is estimated. Again,
\autoref{fig:mean_cosine_sim_rd_example} helps to visually analyse this
question for the two sample new publisher \emph{Handelsblatt} and
\emph{Bild.de} (see \autoref{fig:mean_cosine_sim_rd} for all news
publisher).
