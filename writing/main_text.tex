...
models. The coefficients for the treatment
variables(e.g.~``TTRUE:B90/GRÜNE'') give the effect of the election day
on the topic similarity depending on the party for a given \(W\). This
can be illustrated using the pair Handelsblatt and B90/GRÜNE as an
example and comparing the model equation for \(D_{B90/GRÜNE} = 1\) and
