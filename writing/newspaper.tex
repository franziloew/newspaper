...
{\centering \subfloat[Total visits in million (Jan 2018)\label{fig:unnamed-chunk-1-1}]{\includegraphics[width=0.49\linewidth]{newspaper_files/figure-latex/unnamed-chunk-1-1} }\subfloat[Use of a brand to access news online\label{fig:unnamed-chunk-1-2}]{\includegraphics[width=0.49\linewidth]{newspaper_files/figure-latex/unnamed-chunk-1-2} }
...
\begin{table}[!htbp] \centering    \caption{Results from the OLS dummy regression}    \label{table:results_ols}  \resizebox{0.99\textwidth}{!}{\begin{tabular}{@{\extracolsep{5pt}}lccccccc}  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{7}{c}{\textit{Dependent variable:}} \\  \cline{2-8}  \\[-1.8ex] & \multicolumn{7}{c}{Cosine similarity of topic distribution} \\   & Bild.de & DIE WELT & FOCUS Online & Handelsblatt & SPIEGEL ONLINE & stern.de & ZEIT ONLINE \\  \\[-1.8ex] & (1) & (2) & (3) & (4) & (5) & (6) & (7)\\  \hline \\[-1.8ex]   B90/GRÜNE & $-$0.055$^{***}$ & $-$0.041$^{***}$ & $-$0.047$^{***}$ & 0.020$^{**}$ & $-$0.021$^{**}$ & $-$0.028$^{***}$ & $-$0.023$^{**}$ \\    & (0.013) & (0.008) & (0.008) & (0.009) & (0.009) & (0.007) & (0.011) \\    & & & & & & & \\   CDU & $-$0.059$^{***}$ & $-$0.040$^{***}$ & $-$0.038$^{***}$ & 0.020$^{**}$ & $-$0.027$^{***}$ & $-$0.014$^{**}$ & $-$0.035$^{***}$ \\    & (0.013) & (0.008) & (0.008) & (0.009) & (0.009) & (0.007) & (0.010) \\    & & & & & & & \\   DIE LINKE & $-$0.047$^{***}$ & $-$0.041$^{***}$ & $-$0.041$^{***}$ & 0.022$^{**}$ & $-$0.027$^{***}$ & $-$0.016$^{**}$ & $-$0.028$^{***}$ \\    & (0.013) & (0.008) & (0.008) & (0.009) & (0.009) & (0.007) & (0.010) \\    & & & & & & & \\   FDP & $-$0.060$^{***}$ & $-$0.045$^{***}$ & $-$0.049$^{***}$ & 0.013 & $-$0.041$^{***}$ & $-$0.026$^{***}$ & $-$0.030$^{***}$ \\    & (0.013) & (0.008) & (0.008) & (0.009) & (0.009) & (0.007) & (0.010) \\    & & & & & & & \\   SPD & $-$0.062$^{***}$ & $-$0.042$^{***}$ & $-$0.047$^{***}$ & 0.016$^{*}$ & $-$0.038$^{***}$ & $-$0.018$^{***}$ & $-$0.029$^{***}$ \\    & (0.013) & (0.008) & (0.008) & (0.009) & (0.009) & (0.007) & (0.010) \\    & & & & & & & \\   Constant & 0.203$^{***}$ & 0.190$^{***}$ & 0.177$^{***}$ & 0.164$^{***}$ & 0.168$^{***}$ & 0.142$^{***}$ & 0.206$^{***}$ \\    & (0.009) & (0.005) & (0.006) & (0.006) & (0.006) & (0.005) & (0.007) \\    & & & & & & & \\  \hline \\[-1.8ex]  Observations & 594 & 683 & 695 & 641 & 695 & 689 & 671 \\  R$^{2}$ & 0.056 & 0.072 & 0.073 & 0.013 & 0.040 & 0.032 & 0.021 \\  Adjusted R$^{2}$ & 0.048 & 0.065 & 0.066 & 0.005 & 0.033 & 0.025 & 0.013 \\  Residual Std. Error & 0.089 (df = 588) & 0.057 (df = 677) & 0.061 (df = 689) & 0.065 (df = 635) & 0.066 (df = 689) & 0.050 (df = 683) & 0.079 (df = 665) \\  F Statistic & 6.951$^{***}$ (df = 5; 588) & 10.466$^{***}$ (df = 5; 677) & 10.807$^{***}$ (df = 5; 689) & 1.647 (df = 5; 635) & 5.693$^{***}$ (df = 5; 689) & 4.486$^{***}$ (df = 5; 683) & 2.798$^{**}$ (df = 5; 665) \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{7}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}}  \end{table}
...
SPIEGEL ONLINE. Furthermore, the figure visualizes that the topic
...
{\centering \includegraphics[width=1\linewidth]{newspaper_files/figure-latex/Plot coefficients - simple dummy-1} 
...
\begin{table}[!htbp] \centering    \caption{Results from the RDiT model}    \label{table:results_rd1}  \resizebox{0.99\textwidth}{!}{\begin{tabular}{@{\extracolsep{5pt}}lccccccc}  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{7}{c}{\textit{Dependent variable:}} \\  \cline{2-8}  \\[-1.8ex] & \multicolumn{7}{c}{Cosine similarity of topic distribution} \\   & Bild.de & DIE WELT & FOCUS Online & Handelsblatt & SPIEGEL ONLINE & stern.de & ZEIT ONLINE \\  \\[-1.8ex] & (1) & (2) & (3) & (4) & (5) & (6) & (7)\\  \hline \\[-1.8ex]   T & $-$0.008 & $-$0.018$^{***}$ & $-$0.009 & $-$0.023$^{***}$ & 0.012$^{*}$ & $-$0.002 & $-$0.014 \\    & (0.009) & (0.007) & (0.006) & (0.009) & (0.007) & (0.007) & (0.009) \\    & & & & & & & \\   W & $-$0.0003$^{***}$ & $-$0.0001$^{**}$ & $-$0.00003 & $-$0.0001 & $-$0.0003$^{***}$ & $-$0.0001$^{*}$ & $-$0.0004$^{***}$ \\    & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) \\    & & & & & & & \\   TTRUE:W & 0.001$^{***}$ & 0.0003$^{***}$ & 0.0001 & 0.001$^{***}$ & 0.0004$^{***}$ & 0.0004$^{***}$ & 0.0005$^{***}$ \\    & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) \\    & & & & & & & \\   Constant & 0.142$^{***}$ & 0.148$^{***}$ & 0.138$^{***}$ & 0.171$^{***}$ & 0.124$^{***}$ & 0.119$^{***}$ & 0.159$^{***}$ \\    & (0.006) & (0.004) & (0.004) & (0.006) & (0.005) & (0.004) & (0.006) \\    & & & & & & & \\  \hline \\[-1.8ex]  Observations & 1,161 & 1,212 & 1,268 & 1,046 & 1,264 & 1,218 & 1,244 \\  R$^{2}$ & 0.016 & 0.027 & 0.005 & 0.036 & 0.014 & 0.014 & 0.048 \\  Adjusted R$^{2}$ & 0.013 & 0.025 & 0.003 & 0.034 & 0.012 & 0.011 & 0.045 \\  Residual Std. Error & 0.079 (df = 1157) & 0.055 (df = 1208) & 0.057 (df = 1264) & 0.072 (df = 1042) & 0.065 (df = 1260) & 0.056 (df = 1214) & 0.083 (df = 1240) \\  F Statistic & 6.076$^{***}$ (df = 3; 1157) & 11.316$^{***}$ (df = 3; 1208) & 2.267$^{*}$ (df = 3; 1264) & 13.155$^{***}$ (df = 3; 1042) & 6.055$^{***}$ (df = 3; 1260) & 5.570$^{***}$ (df = 3; 1214) & 20.630$^{***}$ (df = 3; 1240) \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{7}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}}  \end{table}
...
{\centering \includegraphics[width=1\linewidth]{newspaper_files/figure-latex/Daily mean cosine similarity - rd example-1} 
...
AfD as well as a positive effect for B90/GRÜNE. In the case of
Handeslblatt a negative effect for CDU can be observed. Since the
figures (see \autoref{fig:mean_cosine_sim_rd} for all news publishers)
suggest that the slope changes after the election day for nearly all
newspaper/party pairs, the interaction term \(T_tD_{t,k-1}\) is included
to capture this effect. Thus, \(\gamma_1, ..., \gamma_{k-1}\) give the
average treatment effect for each newspaper/party pair in the following
equation.
...
\begin{table}[!htbp] \centering    \caption{Results from the regression discontinuity model}    \label{table:results_rd2}  \resizebox{0.99\textwidth}{!}{\begin{tabular}{@{\extracolsep{5pt}}lccccccc}  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{7}{c}{\textit{Dependent variable:}} \\  \cline{2-8}  \\[-1.8ex] & \multicolumn{7}{c}{Cosine similarity of topic distribution} \\   & Bild.de & DIE WELT & FOCUS Online & Handelsblatt & SPIEGEL ONLINE & stern.de & ZEIT ONLINE \\  \\[-1.8ex] & (1) & (2) & (3) & (4) & (5) & (6) & (7)\\  \hline \\[-1.8ex]   T & $-$0.031$^{**}$ & $-$0.025$^{***}$ & $-$0.015$^{*}$ & $-$0.012 & 0.011 & $-$0.001 & $-$0.013 \\    & (0.013) & (0.009) & (0.009) & (0.013) & (0.011) & (0.010) & (0.014) \\    & & & & & & & \\   W & $-$0.0003$^{***}$ & $-$0.0001$^{**}$ & $-$0.00003 & $-$0.0001 & $-$0.0003$^{***}$ & $-$0.0001$^{*}$ & $-$0.0004$^{***}$ \\    & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) \\    & & & & & & & \\   B90/GRÜNE & $-$0.053$^{***}$ & $-$0.041$^{***}$ & $-$0.046$^{***}$ & 0.022$^{**}$ & $-$0.020$^{**}$ & $-$0.026$^{***}$ & $-$0.021$^{*}$ \\    & (0.011) & (0.007) & (0.007) & (0.010) & (0.008) & (0.007) & (0.011) \\    & & & & & & & \\   CDU & $-$0.058$^{***}$ & $-$0.039$^{***}$ & $-$0.037$^{***}$ & 0.022$^{**}$ & $-$0.025$^{***}$ & $-$0.013$^{*}$ & $-$0.033$^{***}$ \\    & (0.011) & (0.007) & (0.007) & (0.010) & (0.008) & (0.007) & (0.011) \\    & & & & & & & \\   DIE LINKE & $-$0.046$^{***}$ & $-$0.041$^{***}$ & $-$0.040$^{***}$ & 0.023$^{**}$ & $-$0.026$^{***}$ & $-$0.015$^{**}$ & $-$0.027$^{**}$ \\    & (0.011) & (0.007) & (0.007) & (0.010) & (0.008) & (0.007) & (0.011) \\    & & & & & & & \\   FDP & $-$0.059$^{***}$ & $-$0.045$^{***}$ & $-$0.049$^{***}$ & 0.014 & $-$0.040$^{***}$ & $-$0.025$^{***}$ & $-$0.028$^{**}$ \\    & (0.011) & (0.007) & (0.007) & (0.010) & (0.008) & (0.007) & (0.011) \\    & & & & & & & \\   SPD & $-$0.061$^{***}$ & $-$0.042$^{***}$ & $-$0.046$^{***}$ & 0.016$^{*}$ & $-$0.038$^{***}$ & $-$0.017$^{**}$ & $-$0.028$^{**}$ \\    & (0.011) & (0.007) & (0.007) & (0.010) & (0.008) & (0.007) & (0.011) \\    & & & & & & & \\   TTRUE:W & 0.001$^{***}$ & 0.0003$^{***}$ & 0.0001 & 0.001$^{***}$ & 0.0003$^{***}$ & 0.0004$^{***}$ & 0.0005$^{***}$ \\    & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) & (0.0001) \\    & & & & & & & \\   TTRUE:B90/GRÜNE & 0.033$^{*}$ & 0.016 & 0.015 & $-$0.028 & $-$0.0002 & $-$0.005 & $-$0.016 \\    & (0.017) & (0.011) & (0.012) & (0.017) & (0.014) & (0.012) & (0.018) \\    & & & & & & & \\   TTRUE:CDU & 0.020 & $-$0.005 & $-$0.008 & $-$0.032$^{**}$ & $-$0.015 & $-$0.021$^{**}$ & $-$0.010 \\    & (0.015) & (0.010) & (0.010) & (0.015) & (0.012) & (0.011) & (0.016) \\    & & & & & & & \\   TTRUE:DIE LINKE & 0.014 & $-$0.001 & $-$0.004 & $-$0.015 & $-$0.009 & $-$0.003 & $-$0.006 \\    & (0.015) & (0.010) & (0.010) & (0.015) & (0.012) & (0.011) & (0.016) \\    & & & & & & & \\   TTRUE:FDP & 0.041$^{***}$ & 0.024$^{**}$ & 0.023$^{**}$ & 0.021 & 0.033$^{***}$ & 0.027$^{**}$ & 0.022 \\    & (0.015) & (0.010) & (0.010) & (0.015) & (0.012) & (0.011) & (0.016) \\    & & & & & & & \\   TTRUE:SPD & 0.035$^{**}$ & 0.009 & 0.011 & $-$0.013 & 0.005 & $-$0.005 & $-$0.001 \\    & (0.015) & (0.010) & (0.011) & (0.015) & (0.012) & (0.011) & (0.016) \\    & & & & & & & \\   Constant & 0.189$^{***}$ & 0.183$^{***}$ & 0.175$^{***}$ & 0.155$^{***}$ & 0.149$^{***}$ & 0.135$^{***}$ & 0.182$^{***}$ \\    & (0.009) & (0.006) & (0.006) & (0.009) & (0.007) & (0.006) & (0.009) \\    & & & & & & & \\  \hline \\[-1.8ex]  Observations & 1,161 & 1,212 & 1,268 & 1,046 & 1,264 & 1,218 & 1,244 \\  R$^{2}$ & 0.065 & 0.107 & 0.088 & 0.060 & 0.062 & 0.054 & 0.074 \\  Adjusted R$^{2}$ & 0.054 & 0.098 & 0.079 & 0.048 & 0.053 & 0.043 & 0.064 \\  Residual Std. Error & 0.077 (df = 1147) & 0.053 (df = 1198) & 0.055 (df = 1254) & 0.071 (df = 1032) & 0.064 (df = 1250) & 0.055 (df = 1204) & 0.082 (df = 1230) \\  F Statistic & 6.114$^{***}$ (df = 13; 1147) & 11.092$^{***}$ (df = 13; 1198) & 9.310$^{***}$ (df = 13; 1254) & 5.072$^{***}$ (df = 13; 1032) & 6.396$^{***}$ (df = 13; 1250) & 5.256$^{***}$ (df = 13; 1204) & 7.572$^{***}$ (df = 13; 1230) \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{7}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}}  \end{table}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{newspaper_files/figure-latex/Plot coefficients - RDiT dummy-1} 
...
effect for the topic similarity for AfD (\(-0.031\)), as well as a
significant positive effect for B90/GRÜNE (\(0.002\)), SPD (\(0.004\))
and FDP (\(0.01\)) holding the respective other variables equal. Besides
Bild.de, in the case of DIE WELT and FOCUS Online, a significant
negative effect of the election day on the topic similarity with AfD
press releases is discernible. The only other negative treatment effect
- except a small negative effect for DIE WELT/FDP - exists for the CDU
in the case of Handelsblatt and stern.de. In both cases, the topic
similarity between the news articles and the CDU press releases
significantly decreased right after the election day. No significant
effect of the election day can be detected in the case of ZEIT ONLINE on
neither of the model specifications.
...
\leavevmode\vadjust pre{\hypertarget{ref-erosheva_mixed-membership_2004}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-van_der_klaauw_estimating_2002}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-lott_is_2014}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-acemoglu_political_2013}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-roberts_stm:_2016}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-thistlethwaite_regression-discontinuity_1960}{}}%
