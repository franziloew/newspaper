...
Following the good results of the AfD in the 2017 federal elections, the inevitable search for those responsible began almost immediately. Quite a few claimed that the selection of topics in the media contributed to the strong results of AfD. The underlying hypothesis of this accusation is that the mere quantity of reporting on a party, or on the issues it embraces, results in its gaining popularity. 
...
1. Have right-wing populists' campaigns really been increasingly present in the media coverage?

2. What incentives do the media have for biased reporting?
...
3. Did the reporting change after the election? 

4. What are possible reasons for a change?

Questions 1. & 3. can be analyzed on the basis of data. The second and the fourth question can be discussed on the basis of existing research.
...
1. OLS without treatment effect: Considering the whole period, is there a difference between topic similarity of a newspaper and AfD compared to the topic similarity of that newspaper and all other parties? 
...
2. OLS with treatment effect (regression discont. model): Does the topic similarity of a newspaper and the AfD significantly change after the election date? 
...
The empirical results do not allow any conclusion about the motivation for selecting topics. However, different motives can be discussed based on the results. Possible reasons: 

- political ideology of the editor
- economic considerations

# 2. Method

## 2.1 Estimate topic similarity
...
- Treatment effect: After the election, cosine similarity of news coverage drops by 11,5% on average. 
- Dummy variables: Compared to AfD, news coverage with all other parties is less similar

**stern.de**

- Treatment effect: After the election, cosine similarity of news coverage drops by 17,7% on average. 
- Dummies: Compared to AfD, news coverage with all other parties is less similar

**Handelsblatt**

- Treatment effect: After the election, cosine similarity of news coverage drops by 15,8% on average. 
...
- Treatment effect: Topic similarity with AfD decreased by 15,9%

**ZEIT ONLINE**

- Treatment effect: Topic similarity with AfD decreased by 18,6% 

**Handelsblatt**

**FOCUS Online**

- Treatment effect: Topic similarity with AfD decreased by 11,8%

- Dummy variables: The cosine similarity is on average less for all parties compared to AfD *BEFORE* the election day. E.g. compared to the AfD, the cosine similarity of topics is 39,9% lower for B90/Grüne, meaning that topic coverage of Bild.de is 39,9% lower for B90/Grüne compared to AfD before the election day.

- Interaction terms: The effect of the election on topic coverage is 13.8% higher for B90/Grüne than for AfD.

$$
\text{CosineSimilarity}_{FOCUS}(D_{B90}=1)=\beta_0-0.118*T-0.399+0.138*T \\
\text{CosineSimilarity}_{FOCUS}(D_{B90}=1)= \beta_0-0.399+T*(-0.118+0.138)
$$
$$
\text{CosineSimilarity}_{FOCUS}(D_{B90}=0)=\beta_0-0.118*T
$$

**Bild.de**

- Treatment effect: Topic similarity with AfD decreased by 17,3%
